...
set FABRIC_EXTS_PATH=%FABRIC_kyle_DIR%\Exts;%KRAKEN_PATH%\Samples\OSS;%KRAKEN_PATH%\Exts;%THIRD_PARTY%;%FABRIC_DIR%\Exts;%FABRIC_EXTS_PATH%

set FABRIC_DFG_PATH=%FABRIC_kyle_DIR%\Exts\DFG;%KRAKEN_PATH%\Presets\DFG;%KRAKEN_PATH%\Presets;%FABRIC_DIR%\Presets\DFG;%FABRIC_DFG_PATH%
