...
cmd /k python DCCIntegrations\kl\presetGen.py %KRAKEN_PATH%\Samples\OSS\klChar\klChar_rig.krg %KRAKEN_PATH%\Samples\OSS\klChar -c %KRAKEN_PATH%\Python\OSS\OSS_kraken_config.py --profiling 5000
