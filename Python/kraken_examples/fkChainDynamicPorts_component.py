...
class FKChainDynmaicPortsComponent(BaseExampleComponent):
    """FK Chain Base"""

    def __init__(self, name='FKChainDynmaicPortsBase', parent=None):

        super(FKChainDynmaicPortsComponent, self).__init__(name, parent)
...
class FKChainDynmaicPortsComponentGuide(FKChainDynmaicPortsComponent):
    """FKChainDynmaicPorts Component Guide"""

    def __init__(self, name='FKChainDynmaicPorts', parent=None):

        Profiler.getInstance().push("Construct FKCHain Guide Component:" + name)
        super(FKChainDynmaicPortsComponentGuide, self).__init__(name, parent)
    ...
    def updateMocap(self, mocap):
        ...
        if mocap:
            if self.mocapInputAttr is None:
                ...
                self.mocapJointOutputTgt = self.createOutput('mocapJoint', dataType='Xfo', parent=self.outputHrcGrp).getTarget()

        else:
            if self.mocapInputAttr is not None:
                self.deleteInput('mocap')
                self.deleteOutput('mocapJoint')
                self.mocapInputAttr = None
    ...
    def saveData(self):
        ...
        data = super(FKChainDynmaicPortsComponentGuide, self).saveData()
    ...
    def loadData(self, data):
        ...
        super(FKChainDynmaicPortsComponentGuide, self).loadData(data)
    ...
    def getRigBuildData(self):
        ...
        data = super(FKChainDynmaicPortsComponentGuide, self).getRigBuildData()
    ...
    def getRigComponentClass(cls):
        ...
        return FKChainDynmaicPortsComponentRig


class FKChainDynmaicPortsComponentRig(FKChainDynmaicPortsComponent):
    """FK Chain Leg Rig"""

    def __init__(self, name='FKChainDynmaicPorts', parent=None):

        Profiler.getInstance().push("Construct FK Chain Rig Component:" + name)
        super(FKChainDynmaicPortsComponentRig, self).__init__(name, parent)
    ...
    def loadData(self, data=None):
        ...
        super(FKChainDynmaicPortsComponentRig, self).loadData( data )
...
ks.registerComponent(FKChainDynmaicPortsComponentGuide)
ks.registerComponent(FKChainDynmaicPortsComponentRig)
